...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all settings (defaults merged)' }),
...
__decorate([
    ...
    (0, audit_decorator_1.Audited)('SETTING_UPDATE', 'Setting'),
    (0, swagger_1.ApiOperation)({ summary: 'Set a configuration value' }),
