...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Range start (ISO 8601). Default: -30d' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Range end (ISO 8601). Default: now' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Date),
    (0, class_validator_1.IsDate)(),
    __metadata("design:type", Date)
